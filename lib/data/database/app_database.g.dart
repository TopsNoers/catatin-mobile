...
class User extends DataClass implements Insertable<User> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, email, name, password, createdAt, updatedAt);
  @override
...
class $UserDetailsTable extends UserDetails
  ...
  static const VerificationMeta _backgroundAppMeta = const VerificationMeta(
    'backgroundApp',
  );
  @override
  late final GeneratedColumn<String> backgroundApp = GeneratedColumn<String>(
    'background_app',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('background_app')) {
      context.handle(
        _backgroundAppMeta,
        backgroundApp.isAcceptableOrUnknown(
          data['background_app']!,
          _backgroundAppMeta,
        ),
      );
  ...
  UserDetail map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return UserDetail(
      ...
      backgroundApp: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}background_app'],
      ),
      createdAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}created_at'],
...
class UserDetail extends DataClass implements Insertable<UserDetail> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || backgroundApp != null) {
      map['background_app'] = Variable<String>(backgroundApp);
    }
    map['created_at'] = Variable<DateTime>(createdAt);
    map['updated_at'] = Variable<DateTime>(updatedAt);
    return map;
  ...
  UserDetailsCompanion toCompanion(bool nullToAbsent) {
    return UserDetailsCompanion(
      ...
      userId: Value(userId),
      theme: Value(theme),
      backgroundApp: backgroundApp == null && nullToAbsent
          ? const Value.absent()
          : Value(backgroundApp),
      createdAt: Value(createdAt),
      updatedAt: Value(updatedAt),
  ...
  factory UserDetail.fromJson(
    ...
    return UserDetail(
      ...
      backgroundApp: serializer.fromJson<String?>(json['backgroundApp']),
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
      updatedAt: serializer.fromJson<DateTime>(json['updatedAt']),
    );
  }
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'backgroundApp': serializer.toJson<String?>(backgroundApp),
      'createdAt': serializer.toJson<DateTime>(createdAt),
      'updatedAt': serializer.toJson<DateTime>(updatedAt),
    };
  }
  ...
  UserDetail copyWith({
    ...
    String? userId,
    String? theme,
    Value<String?> backgroundApp = const Value.absent(),
    DateTime? createdAt,
    DateTime? updatedAt,
  }) => UserDetail(
    id: id ?? this.id,
    ...
    backgroundApp: backgroundApp.present
        ? backgroundApp.value
        : this.backgroundApp,
    createdAt: createdAt ?? this.createdAt,
    updatedAt: updatedAt ?? this.updatedAt,
  ...
  UserDetail copyWithCompanion(UserDetailsCompanion data) {
    return UserDetail(
      ...
      backgroundApp: data.backgroundApp.present
          ? data.backgroundApp.value
          : this.backgroundApp,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
    );
  ...
  String toString() {
    return (StringBuffer('UserDetail(')
          ...
          ..write('userId: $userId, ')
          ..write('theme: $theme, ')
          ..write('backgroundApp: $backgroundApp, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt')
          ..write(')'))
        .toString();
  ...
  @override
  int get hashCode =>
      Object.hash(id, userId, theme, backgroundApp, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is UserDetail &&
          ...
          other.backgroundApp == this.backgroundApp &&
          other.createdAt == this.createdAt &&
          other.updatedAt == this.updatedAt);
}
...
class UserDetailsCompanion extends UpdateCompanion<UserDetail> {
  ...
  final Value<String?> backgroundApp;
  final Value<DateTime> createdAt;
  final Value<DateTime> updatedAt;
  final Value<int> rowid;
  const UserDetailsCompanion({
    ...
    this.backgroundApp = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ...
  static Insertable<UserDetail> custom({
    ...
    Expression<String>? backgroundApp,
    Expression<DateTime>? createdAt,
    Expression<DateTime>? updatedAt,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
      ...
      if (backgroundApp != null) 'background_app': backgroundApp,
      if (createdAt != null) 'created_at': createdAt,
      if (updatedAt != null) 'updated_at': updatedAt,
      if (rowid != null) 'rowid': rowid,
    });
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (backgroundApp.present) {
      map['background_app'] = Variable<String>(backgroundApp.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<DateTime>(createdAt.value);
    }
...
class Wallet extends DataClass implements Insertable<Wallet> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, userId, name, icon, color, balance, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Wallet &&
...
final class $$UsersTableReferences
  ...
  _userDetailsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.userDetails,
    aliasName: $_aliasNameGenerator(db.users.id, db.userDetails.userId),
  );
...
final class $$UserDetailsTableReferences
  ...
  static $UsersTable _userIdTable(_$AppDatabase db) => db.users.createAlias(
    $_aliasNameGenerator(db.userDetails.userId, db.users.id),
  );
...
class $$UserDetailsTableFilterComposer
  ...
  ColumnFilters<String> get backgroundApp => $composableBuilder(
    column: $table.backgroundApp,
    builder: (column) => ColumnFilters(column),
  );
...
class $$UserDetailsTableOrderingComposer
  ...
  ColumnOrderings<String> get backgroundApp => $composableBuilder(
    column: $table.backgroundApp,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$UserDetailsTableAnnotationComposer
  ...
  GeneratedColumn<String> get backgroundApp => $composableBuilder(
    column: $table.backgroundApp,
                      ...
                      state =
                          state.withJoin(
                                ...
                                referencedTable: $$UserDetailsTableReferences
                                    ._userIdTable(db),
                                referencedColumn: $$UserDetailsTableReferences
                                    ._userIdTable(db)
                                    .id,
                              )
                              as T;
...
class $$TransactionsTableTableManager
    extends
        RootTableManager<
          ...
          Transaction,
          PrefetchHooks Function({bool userId, bool walletId, bool categoryId})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({userId = false, walletId = false, categoryId = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [],
                  addJoins:
